...
class Discriminator(nn.Module):
    def __init__(self):
        ...
        self.block2 = Discriminator_Block(32, 32)                             # 64 x 64
        self.block3 = Discriminator_Block(32, 64)                             # 32 x 32
        self.block4 = Discriminator_Block(64, 128)                            # 16 x 16
        self.block5 = Discriminator_Block(128, 256)                            # 8 x 8
